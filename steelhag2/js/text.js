...
const TEXT = {
  ...
  pause: 'Nothing hunts in daylight. You can always sit down. Sitting down keeps your place. Some things answer. Some things only happen if you wait.',
  quietPause: 'Bearers will watch. They will not carry you.',
  ...
  lines: [
    ...
    { id: 'ii5', ch: 2, when: 'standoff', text: 'The prompt said reach out. I had spent eight years wanting to.' },
  ...
  prompts: {
    reach: 'reach out', hold: 'hold…', sit: 'sit down', stand: 'stand up', sleep: 'sleep', photo: 'take the photograph', cellar: 'the cellar door', cellarEmpty: 'nothing to develop yet', doorLocked: 'not yet. it is not dark yet.',
    develop: 'develop the prints', cut: 'cut', standoff: 'it is close enough. hold still, and reach out.',
  },
  seatLines: {},
  ending: 'The slice ends here. The rest of the ice road is still being painted.',
