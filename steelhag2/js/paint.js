...
'use strict';
const MAT = { SNOW: 0, ICE: 1, STEEL: 2, RED: 3, PLANK: 4, CONCRETE: 5, BIRCH: 6, ROOF: 7, BEIGE: 8, DARK: 9, GLASS: 10, ROAD: 11, FOIL: 12, REED: 13, FLAT: 14, LED: 15, CABLE: 16, SPRUCE: 17, WINDOW: 18, CLOTH: 19, BADGE: 20, TRACK: 21, COLD_LIGHT: 22, FOLIAGE: 23, HULL_PLATE: 24, PATH: 25, NOTE: 26, WINDOW_TREE: 27 };
const MATS = 28, TEX = 256;
...
const Paint = (() => {
  ...
  function paintAll() {
    ...
    put(MAT.NOTE,(g)=>{fill(g,'#d9cbb0');g.strokeStyle='#a9a28e';for(let y=25;y<256;y+=25){g.beginPath();g.moveTo(16,y);g.lineTo(238,y);g.stroke();}g.fillStyle='#4b5148';g.font='16px monospace';['16 DECEMBER 1997','18:40','FOUND ONE','ON THE ICE.','BROUGHT IN.'].forEach((t,i)=>g.fillText(t,22,40+i*34));},1);
    put(MAT.PATH,(g)=>fill(g,'#ffffff'),1);
