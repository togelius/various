#!/usr/bin/env python3
"""Inline the stylesheet and scripts into one file: dist/stalhagen2.html (and an artifact variant)."""
import pathlib, re
...
out2 = root / 'dist' / 'stalhagen2-artifact.html'
out2.write_text(art)
