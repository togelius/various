...
for(const n of ['math','assets','meshes','streets','city','world','peds','vehicles','player','police','missions'])vm.runInContext(fs.readFileSync(path.join(__dirname,'../js',n+'.js'),'utf8'),ctx,{filename:n+'.js'});
